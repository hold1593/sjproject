...
public class BoardDao {
	...
	public List<Board> selectList(Connection conn, int currentPage, int limit) throws Exception {
		...
		try {
			...
			while (rset.next()) {
				board = new Board(rset.getInt("BOARD_NO"), rset.getString("BOARD_TITLE"), rset.getInt("BOARD_COUNT"),
						rset.getDate("BOARD_MODIFY_DT"), rset.getString("MEMBER_ID"), rset.getString("CATEGORY_NM"));
	...
	public Board selectBoard(Connection conn, int boardNo) throws Exception {
		...
		try {
			...
			if (rset.next()) {
				board = new Board(boardNo, rset.getString("BOARD_TITLE"), rset.getString("BOARD_CONTENT"),
						rset.getInt("BOARD_COUNT"), rset.getDate("BOARD_MODIFY_DT"), rset.getString("MEMBER_ID"),
	...
	public List<Attachment> selectFiles(Connection conn, int boardNo) throws Exception {
		...
		try {
			...
			while (rset.next()) {
				file = new Attachment(rset.getInt(1), rset.getInt(2), rset.getString(3), rset.getString(4),
						rset.getString(5), rset.getDate(6), rset.getInt(7), rset.getInt(8));
	...
	public Attachment selectFile(Connection conn, int fNo) throws Exception {
		...
		try {
			...
			if (rset.next()) {
				file = new Attachment(rset.getString("FILE_ORIGIN_NAME"), rset.getString("FILE_CHANGE_NAME"),
